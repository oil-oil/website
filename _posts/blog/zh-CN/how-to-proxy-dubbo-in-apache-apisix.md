...
author: "钱勇"
href: "https://github.com/nic-6443"
avatar: "https://avatars.githubusercontent.com/u/22141303?v=4"
date: "2022-01-14"
keywords: Apache APISIX,Apache Dubbo,代理操作,插件
...
说明：上述代码返回中包含了 `test: 123` Header，以及 `dubbo success` 字符串作为 Body 体。这与我们在 `DemoServiceImpl` 编码的预期效果一致。
...
说明：通过 `httpRequestContext` 可以拿到 HTTP 请求的 Header 和 Body。其中 Header 会作为 Map 元素，而 Body 中 Key 值是固定的字符串"body"，Value 则代表 Byte 数组。
